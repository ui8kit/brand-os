# MKulgin Brand OS Library Prompt
...
- libraryTone: {{libraryTone}}
- libraryConstraints: {{libraryConstraints}}
- accessibilityRequirements: {{accessibilityRequirements}}

## Surface Goal
Present books, engineering foundations, and intellectual capital as part of the brand's trust layer.
...
## Surface Overrides
- Use MKulgin Brand OS shapes and spacing consistently on library.
...
## Audit Checklist
- Does library keep the same brand language as other surfaces?
...
## Copy-Ready Prompt
```text
Design a library surface in the MKulgin Brand OS style.
...
Surface goal: Present books, engineering foundations, and intellectual capital as part of the brand's trust layer.
...
Suggested page purpose: Present books, engineering foundations, and intellectual capital as part of the brand's trust layer.
Suggested required sections: library-hero, books-shelf, book-context, quote-callout
...
- Design a library in MKulgin Brand OS.
- Input: {{libraryHero}}
- Input: {{booksShelf}}
- Input: {{bookContext}}
- Input: {{quoteCallout}}
