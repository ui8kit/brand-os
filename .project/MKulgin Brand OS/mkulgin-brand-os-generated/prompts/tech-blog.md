# MKulgin Brand OS Tech Blog Prompt
...
## Surface Goal
List essays, case studies, and operator notes with editorial rhythm and strong topical categorization.
...
## Surface Overrides
- Use MKulgin Brand OS shapes and spacing consistently on tech-blog.
...
## Copy-Ready Prompt
```text
Design a tech-blog surface in the MKulgin Brand OS style.
...
Surface goal: List essays, case studies, and operator notes with editorial rhythm and strong topical categorization.
...
Suggested page purpose: List essays, case studies, and operator notes with editorial rhythm and strong topical categorization.
Suggested required sections: blog-hero, content-pillars, article-list, quote-callout, newsletter-panel
...
- Design a tech blog in MKulgin Brand OS.
- Input: {{blogHero}}
