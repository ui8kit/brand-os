...
## Surface Goal
Collect videos, interviews, external media, and platform presence into a coherent proof surface.
...
## Surface Overrides
- Use MKulgin Brand OS shapes and spacing consistently on media.
...
## Audit Checklist
- Does media keep the same brand language as other surfaces?
...
## Copy-Ready Prompt
```text
Design a media surface in the MKulgin Brand OS style.
...
Surface goal: Collect videos, interviews, external media, and platform presence into a coherent proof surface.
...
Suggested page purpose: Collect videos, interviews, external media, and platform presence into a coherent proof surface.
Suggested required sections: media-hero, media-list, platform-grid, quote-callout
...
- Design a media in MKulgin Brand OS.
- Input: {{mediaHero}}
- Input: {{mediaList}}
- Input: {{platformGrid}}
- Input: {{quoteCallout}}
